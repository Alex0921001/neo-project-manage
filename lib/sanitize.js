 ...
 *
 * 白名单标签：p, br, ul, ol, li, h1-h6, strong, b, em, i, u, s, del, code, pre, blockquote, a, img, span, table, thead, tbody, tr, th, td
 * 白名单属性：a[href], img[src, alt, title], td[colspan, rowspan], th[colspan, rowspan]
 ...
 * 注：本地单机工具，XSS 面低；表格标签为纯结构容器（无属性），放行不扩大属性面
 */
