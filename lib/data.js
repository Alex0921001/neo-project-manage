...
export function createDataAccess(dataDir) {
  ...
  const ctx = { db, shortId, escapeLike, htmlToPlain, truncateText, sanitizeHtml, richTextEmpty, normalizeDate, localToday, addDays, resolveRowById,
    logAudit, auditText, listProjects, summarizeProject, createTask, parseAssignees, parseMembers, parseSessionIds };
