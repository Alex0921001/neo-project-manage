  ...
  <div :class="['detail-meta', statusClass(displayStatus)]">
    ...
    <div class="meta-head">
      ...
      <div class="meta-actions">
        ...
        <button class="icon-btn" v-if="project" title="项目内搜索（Ctrl+F 为全局搜索）" @click="$emit('search')">
...
const emit = defineEmits(["edit", "back", "delete", "change-status", "archive", "unarchive", "search"]);
...
const fullTitle = computed(() => {
  ...
  return props.project.archived ? `${name}（已归档）` : name;
});
